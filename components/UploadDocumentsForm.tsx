...
// import pdfLoader from "./handlePDFLoader";

export function UploadDocumentsForm() {
  const [file, setFile] = useState<File | null>(null);
  const [isLoading, setIsLoading] = useState(false);
  const [document, setDocument] = useState<string>(DEFAULT_RETRIEVAL_TEXT);
  ...
  // console.log(response);
    ...
    // console.log(response);
      ...
      //   setDocument(json.error || "Upload failed");
      // }
  ...
  return (
    <form onSubmit={ingest} className="flex w-[400px] gap-8 mb-4">
      <input
